---
title: "Web Push overview (web.dev)"
source: "https://web.dev/articles/push-notifications-overview"
final_url: "https://web.dev/articles/push-notifications-overview"
...
sha256: "f0cfff49f40bff51bbd786c593b9d8b9c15a2abad25c7908723b24c965a25be3"
---

# Push notifications overview Stay organized with collections Save and categorize content based on your preferences.
...
3. Adding client logic to receive messages that have been pushed to the device
...
call [`Notification.requestPermission()`](https://developer.mozilla.org/docs/Web/API/Notification/requestPermission). The operating system or
...
using the [Push API](https://developer.mozilla.org/docs/Web/API/Push_API). You'll need to provide a public authentication key
...
worker](/articles/service-workers-cache-storage#service_workers). A service worker is
...
- [Handling Messages](/articles/push-notifications-handling-messages)
...
- [Push Notifications FAQ](/articles/push-notifications-faq)
