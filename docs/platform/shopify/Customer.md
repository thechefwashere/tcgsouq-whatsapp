...
source: "https://shopify.dev/docs/api/admin-graphql/2026-07/objects/Customer"
final_url: "https://shopify.dev/docs/api/admin-graphql/latest/objects/Customer"
platform: "shopify"
...
sha256: "a3dc4784ac5636dd6b272453301781138dc8ecf9c1b3354ae19b442b0295129b"
---
...
**Caution:** Only use this data if it&#39;s required for your app&#39;s functionality. Shopify will
restrict <a href="https://shopify.dev/api/usage/access-scopes">access to scopes</a> for
apps that don&#39;t have a legitimate use for the associated data.
...
- firstName (String)
- id (ID!)
- identityProviderSubjects ([IdentityProviderSubject!]!)
- image (Image!)
- lastName (String)
- lastOrder (Order)
...
:   The full name of the customer, based on the values for first\_name and last\_name. If the first\_name and
    last\_name are not available, then this falls back to the customer's email
...
[Anchor to identityProviderSubjects](/docs/api/admin-graphql/latest/objects/Customer#field-Customer.fields.identityProviderSubjects)identityProviderSubjects •[[IdentityProviderSubject!]!](/docs/api/admin-graphql/latest/objects/IdentityProviderSubject) non-null
...
[Anchor to taxSettings](/docs/api/admin-graphql/latest/objects/Customer#field-Customer.fields.taxSettings)taxSettings •[TaxSettings!](/docs/api/admin-graphql/latest/objects/TaxSettings) non-null
...
:   Updates a [`Customer`](https://shopify.dev/docs/api/admin-graphql/latest/objects/Customer)'s email marketing consent information. The customer must have an email address
    ...
    NOT\_SUBSCRIBED, REDACTED, and INVALID cannot be set via this mutation; they are
...
:   Sends an email to a customer containing a secure link to update a specific
    ...
    details for ongoing subscriptions. The email can be customized with sender and BCC fields.
