...
final_url: "https://shopify.dev/docs/apps/build/online-store/app-proxies"
platform: "shopify"
...
sha256: "710eb4ce9b8da0ed2601415fe52e45082f82b0a90e92105a970cbf4a5dad9527"
---
...
- You're a [user with app development permissions](/docs/apps/build/dev-dashboard/user-permissions) and have created a [dev store](/docs/apps/build/stores/development-stores). You can create one by running `shopify store create dev`.
...
1. In `shopify.app.toml` in the root of your app, add the [`write_app_proxy`](/docs/api/usage/access-scopes) access scope.
